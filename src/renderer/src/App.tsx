...
function App(): React.JSX.Element {
  ...
  return (
    <div className="flex flex-col h-screen bg-neutral-50 dark:bg-neutral-900 text-neutral-900 dark:text-neutral-100">
      {/* Toolbar with history and settings buttons */}
      <div className="flex-shrink-0 flex items-center justify-end px-4 py-2 border-b border-neutral-200 dark:border-neutral-800">
